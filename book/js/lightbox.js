...
(function() {
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.sizeContainer = function(imageWidth, imageHeight) {
			...
			maxW = imageWidth / imageHeight * $(window).height()*0.8;
			maxH = imageHeight / imageWidth * $(window).width()*0.8;
			
			if(imageWidth > maxW || imageHeight > maxH) {
	
				if (imageWidth > imageHeight) {
					imageHeight = maxH;
					imageWidth = $(window).width()*0.8;
				}
				else {
				imageHeight = $(window).height()*0.8;
				imageWidth = maxW;
				}
			}
